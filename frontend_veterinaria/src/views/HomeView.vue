...
<template>
  <main>
              ...
              <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <div class="hero__caption">
                  ...
                  <p data-animation="fadeInUp" data-delay=".6s">
                    ...
                    dolore magna sectetur adipisci.
                  </p>
                  <a href="#" class="hero-btn" data-animation="fadeInLeft" data-delay=".3s"
                    >Contact Now<i class="ti-arrow-right"></i>
                  </a>
                </div>
              </div>
            </div>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-services text-center mb-30">
              ...
              <div class="services-cap">
                ...
                <p>
                  consectetur adipiscing elit, serfd dgo eiusmod tempor incididunt ut ore et dolore
                  magna aliqua.
                </p>
              </div>
            </div>
      ...
      <div class="about-details">
        <div class="right-caption">
          ...
          <div class="section-tittle mb-50">
            <h2>
              We are commited for<br />
              better service
            </h2>
          </div>
          <div class="about-more">
            <p class="pera-top">
              Mollit anim laborum duis adseu dolor iuyn voluptcate velit ess <br />cillum dolore
              egru lofrre dsu.
            </p>
            <p class="mb-65 pera-bottom">
              Mollit anim laborum.Dvcuis aute serunt iruxvfg dhjkolohr indd re voluptate velit
              esscillumlore eu quife nrulla parihatur. Excghcepteur sfwsignjnt occa cupidatat non
              aute iruxvfg dhjinulpadeserunt moll.
            </p>
    ...
    <div
      class="contact-animal-owner section-bg"
          ...
          <div class="col-lg-8">
            <div class="contact_text text-center">
              <div class="section_title text-center">
                ...
                <p>
                  Because we know that even the best technology is only as good as the people behind
                  it. 24/7 tech support.
                </p>
              </div>
