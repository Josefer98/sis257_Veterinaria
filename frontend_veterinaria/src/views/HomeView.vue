              ...
              <div class="col-xl-7 col-lg-8 col-md-10">
                ...
                <div class="video-icon">
                  <a
                    ...
                    href="https://www.youtube.com/watch?v=3tlwxbX1x_o"
                ...
                <div class="hero__caption">
                  <span data-animation="fadeInUp" data-delay=".3s"
                    >Tu mascota es familia. Nosotros lo sabemos.</span
                  >
                  <h1 data-animation="fadeInUp" data-delay=".3s">Cuidamos de sus mascotas.</h1>
                  <p data-animation="fadeInUp" data-delay=".6s">
                    En PetCare, creemos que cada ladrido, ronroneo o aleteo merece atención médica
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-services text-center mb-30">
              ...
              <div class="services-cap">
                ...
                <p>
                  Desde consultas generales hasta planes de recuperación, ofrecemos diagnóstico,
                  medicación y seguimiento con tecnología moderna y un enfoque humano. Porque cada
                  síntoma merece atención seria y oportuna.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-services text-center mb-30">
              ...
              <div class="services-cap">
                ...
                <p>
                  Protegemos a tu mascota contra enfermedades prevenibles con un plan de vacunación
                  personalizado, actualizado y aplicado por profesionales certificados. Porque la
                  prevención es el primer paso hacia una vida sana.
                </p>
              </div>
            </div>
          </div>
      ...
      <div class="about-details">
        <div class="right-caption">
          ...
          <div class="about-more">
            <p class="pera-top">
              Nuestro compromiso diario es elevar la calidad del servicio, porque la salud de tu
              mascota no admite medias tintas.
            </p>
            <p class="mb-65 pera-bottom">
              Cada detalle cuenta: por eso nos esforzamos cada día por ofrecerte un mejor servicio,
              con más cuidado, más atención y más corazón.
            </p>
          ...
          <div class="col-lg-4 col-md-6 col-sm-6">
            <div class="single-gallery mb-30">
              ...
              <div
                ...
                style="background-image: url(/src/assets/img/gallery/gallery1.png)"
              ></div>
            </div>
          </div>
