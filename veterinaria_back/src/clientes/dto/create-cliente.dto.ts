...
export class CreateClienteDto {
  ...
  @MaxLength(100, {
    message: 'El campo nombres no debe exceder los 100 caracteres',
  })
  ...
  @MaxLength(15, {
    message: 'El campo teléfono no debe exceder los 15 caracteres',
  })
  @Transform(({ value }): string | undefined =>
    typeof value === 'string' ? value.trim() : value,
  )
  ...
  @MaxLength(50, {
    message: 'El campo dirección no debe exceder los 50 caracteres',
  })
  @Transform(({ value }): string | undefined =>
    typeof value === 'string' ? value.trim() : value,
  )
